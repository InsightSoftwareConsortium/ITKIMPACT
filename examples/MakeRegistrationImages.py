...
def configs(args):
    for path in args.models:
        yield itk.ImpactModelConfiguration(path, 3, 1, [0, 0, 0], [args.voxel] * 3, [0] * 3, [True], False)
...
def organ_mask(fixed, model, device, dilation=10):
    ...
    segmenter.SetModelConfiguration(
        itk.ImpactModelConfiguration(model, 3, 1, [128, 128, 128], [1.5] * 3, [32] * 3, layers, False))
